//extract methods
// - used to turn code fragments into a method with a descriptive name
// - used to make code as readable as comments
...
public class FootballPlayer40YardDashInfo {
	...
	public void printPlayerInfo(){
		...
		printTitles(); // Prints the titles
		
		/* // place this code in its own method printTitles()
		...
		*/
		...
		/* // place this code in its own method printPlayersWith40Avg()
	...
	// to print characters multiple times
...
//keepuing the lines short (<10 lines), to have better understanding of whats going on
/*
double average 0.0;
